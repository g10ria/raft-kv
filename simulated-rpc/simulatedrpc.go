package simulatedrpc

//
// channel-based RPC, used as an in-memory network for testing.
//
...
func (rs *Server) dispatch(req reqMsg) replyMsg {
	...
	if ok {
		...
		log.Fatalf("simulatedrpc.Server.dispatch(): unknown service %v in %v.%v; expecting one of %v\n",
...
func (svc *Service) dispatch(methname string, req reqMsg) replyMsg {
	if method, ok := svc.methods[methname]; ok {
		...
		log.Fatalf("simulatedrpc.Service.dispatch(): unknown method %v in %v; expecting one of %v\n",
